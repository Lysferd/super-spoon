...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post residents_url, params: { resident: { facility_id: @resident.facility_id, name: @resident.name } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { facility_id: @resident.facility_id, name: @resident.name } }
